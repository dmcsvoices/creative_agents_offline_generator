...
def main():
    ...
    with torch.inference_mode():
        ...
        cliptextencode_45 = cliptextencode.encode(
            text="\n'A surreal digital romance: two figures made of glowing code and shadowed hands, dancing in a neon-lit server room with floating data streams. The atmosphere is charged with electric intimacy, blending tech and human emotion.\n  \n    'subject': 'digital love',\n    'background': 'neon server room with holographic cables',\n    'lighting': 'soft bioluminescent glow'\n",
        ...
        for q in range(1):
            modelsamplingauraflow_47 = modelsamplingauraflow.patch_aura(
                shift=3, model=get_value_at_index(unetloader_46, 0)
            )
            ...
            saveimage_9 = saveimage.save_images(
                filename_prefix="z-image", images=get_value_at_index(vaedecode_43, 0)
            )
